const base = {
	...
	metadataBase: '/',
	keywords: ['乘风', '多语言', '外贸', '独立站', '建站', '人工智能', 'ChatGPT', 'AI', '外贸CRM', '外贸CMS', '外贸培训', '外贸自媒体'],
	authors: [
		{
			name: 'huglemon',
	...
	navLinks: [
		...
		{ name: '外贸培训', url: '/lesson' },
		{ name: '视频翻译', url: '/ai-boss' },
		{
			name: '免费工具',
			url: '/tools',
			items: [
				{ name: '万能导航', url: '/tools' },
				{ name: '免费抠图', url: 'https://rm.inwind.cn' },
				{ name: '全球时区查询', url: 'https://whenthey.work' },
			],
		},

		{ name: '个人中心', url: '/dashboard' }
	],
	aboutLinks: [
		{
			name: '独立站',
